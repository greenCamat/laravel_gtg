...
wu.WiderContact.prototype.connect = function ( key, sig ) {
	this.api_key = key;
	this.api_sig = sig;
};
...
wu.WiderContact.prototype.post = function (on_complete_func, url, request_data, parse_data) {
	...
	request_data.api_sig = this.api_sig;
	 
	$.post(full_url, request_data, callback, 'text');
};

wu.WiderContact.prototype.subscribe = function ( data, callback ) {
    this.post( callback , "api/subscribe" , data );
};

/*
wu.WiderContact.prototype.add_contact = function ( data, callback ) {
	this.post( callback , "api/add_contact" , data );
};

wu.WiderContact.prototype.list_contacts = function ( data, callback ) {
	this.post( callback, "api/list_contacts" , data );
};

wu.WiderContact.prototype.get_contact  = function ( data, callback ) {
	this.post( callback , "api/get_contact" , data );
};

wu.WiderContact.prototype.edit_contact  = function ( data , callback ) {
	this.post( callback , "api/edit_contact" , data );
};

wu.WiderContact.prototype.delete_contact  = function ( data, callback  ) {
	this.post( callback , "api/delete_contact" , data );
};
...
wu.widercontact = new wu.WiderContact();
